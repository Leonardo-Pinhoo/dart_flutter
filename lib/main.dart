...
const List<Categoria> categoriasDisponiveis = [
  ...
  Categoria(
      nome: 'Aluguel', icone: Icons.house_rounded, cor: Color(0xFF9B6BF2)),
  Categoria(
      nome: 'Supermercado',
      icone: Icons.shopping_cart_rounded,
      cor: Color(0xFF4CAF7D)),
  Categoria(nome: 'Internet', icone: Icons.wifi_rounded, cor: Color(0xFF4FA8E0)),
  Categoria(
      nome: 'Combustível',
  ...
  Categoria(nome: 'Saúde', icone: Icons.favorite_rounded, cor: Color(0xFFE0608F)),
  Categoria(
      nome: 'Transporte',
            ...
            children: [
              ...
              Wrap(
                ...
                children: categoriasDisponiveis.map((categoria) {
                  final selecionada = categoria.nome == _categoriaSelecionada.nome;
                  return GestureDetector(
                    onTap: () =>
